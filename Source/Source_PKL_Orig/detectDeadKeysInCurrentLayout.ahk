...
So... If I would like to send ~, I must send ~{Space}. This script detect these characters
...
_detectDeadKeysInCurrentLayout_GetLocale( variable, value = "", set = 0 )
{
	...
	static lMSGBOX := "To detect the deadkeys in the current default OS keyboard layout,`nI need an editor.`n`nClick Yes to open Notepad`nClick No if you are already in an editor`nClick Cancel if you KNOW your system doesn't have dead keys"

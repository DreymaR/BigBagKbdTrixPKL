...
* Special letters are on AltGr(RAlt) plus letters A D E I O Y W (I and Y are duplicates, to test which is better)
...
* To use, copy and replace all the contents of this folder into the main PKL folder.
* If you wish, keep backups of the existing files. I've included a backup of the original ANSI layout.ini file.
* Then run/refresh PKL and hopefully it should work.

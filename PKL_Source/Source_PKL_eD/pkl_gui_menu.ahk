...
pkl_about()
{
	...
	layName  := pklIniRead( "layoutname", locUnknown, "Lay_Ini", "information" )
	layVers  := pklIniRead( "version"   , locUnknown, "Lay_Ini", "information" )
	layCode  := pklIniRead( "layoutcode", locUnknown, "Lay_Ini", "information" )
	layCopy  := pklIniRead( "copyright" , locUnknown, "Lay_Ini", "information" )
	layComp  := pklIniRead( "company"   , locUnknown, "Lay_Ini", "information" )
	layPage  := pklIniRead( "homepage"  , ""        , "Lay_Ini", "information" )
	lLocale  := pklIniRead( "localeid"  , "0409"    , "Lay_Ini", "information" )
